%% RACKF
function [X, P, e_IMM, S_IMM, u_IMM, X_CKF,X_RCKF,X_ACKF,P_CKF,P_RCKF,P_ACKF,pij,D_RCKF_Singer,D_ACKF_Singer] = RACKF_Singer(X_CKF,X_RCKF,X_ACKF,P_CKF,P_RCKF,P_ACKF, Z, A,  Q, R, u_IMM,pij,t,D_RCKF_Singer,D_ACKF_Singer)
 n = length(X_ACKF); % 状态维度
    ...
    % 第二步: 模型条件滤波
    [X_CKF, P_CKF, r_CKF, S_CKF] = CKF_Singer(x01, P01, Z, A,  Q, R);
    [X_ACKF, P_ACKF, r_ACKF, S_ACKF,D_ACKF_Singer] = ACKF_Singer(x02, P02, Z, A,  Q, R,t,D_ACKF_Singer);
    [X_RCKF, P_RCKF, r_RCKF, S_RCKF,D_RCKF_Singer] = RCKF_Singer(x03, P03, Z, A,  Q, R,t,D_RCKF_Singer);
